...
def Main():
    ...
    past_data = {}
    with open("cyberJson/juniperText.json", "r", encoding="utf-8") as file:
    ...
    with open("cyberJson/juniperText.jsonl","w",encoding="utf-8") as file:
    ...
    with open("cyberJson/juniperText.json","w",encoding="utf-8") as file:
