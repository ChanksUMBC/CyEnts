...
def Main():
    ...
    past_data = {}
    with open("cyberJson/fireeyeText.json", "r", encoding="utf-8") as file:
    ...
    with open("cyberJson/fireeyeText.jsonl","w",encoding="utf-8") as file:
    ...
    with open("cyberJson/fireeyeText.json","w",encoding="utf-8") as file:
