...
def Main():
    ...
    past_data = {}
    with open("cyberJson/ibmText.json", "r", encoding="utf-8") as file:
    ...
    with open("cyberJson/ibmText.jsonl","w",encoding="utf-8") as file:
    ...
    with open("cyberJson/ibmText.json","w",encoding="utf-8") as file:
