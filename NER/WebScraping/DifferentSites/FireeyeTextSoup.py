...
def Main():
    ...
    past_data = {}
    with open("CyberText/cyberJson/fireeyeText.json", "r", encoding="utf-8") as file:
    ...
    with open("CyberText/cyberJson/fireeyeText.jsonl","w",encoding="utf-8") as file:
    ...
    with open("CyberText/cyberJson/fireeyeText.json","w",encoding="utf-8") as file:
