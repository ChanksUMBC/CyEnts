...
def Main():
    ...
    past_data = {}
    with open("CyberText/cyberJson/ibmText.json", "r", encoding="utf-8") as file:
    ...
    with open("CyberText/cyberJson/ibmText.jsonl","w",encoding="utf-8") as file:
    ...
    with open("CyberText/cyberJson/ibmText.json","w",encoding="utf-8") as file:
