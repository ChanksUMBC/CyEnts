...
def Main():
    ...
    past_data = {}
    with open("CyberText/cyberJson/fortinetText.json", "r", encoding="utf-8") as file:
    ...
    with open("CyberText/cyberJson/fortinetText.jsonl","w",encoding="utf-8") as file:
    ...
    with open("CyberText/cyberJson/fortinetText.json","w",encoding="utf-8") as file:
