...
def Main():
    ...
    past_data = {}
    with open("CyberText/cyberJson/juniperText.json", "r", encoding="utf-8") as file:
    ...
    with open("CyberText/cyberJson/juniperText.jsonl","w",encoding="utf-8") as file:
    ...
    with open("CyberText/cyberJson/juniperText.json","w",encoding="utf-8") as file:
