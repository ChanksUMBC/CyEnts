...
def Main():
    ...
    past_data = {}
    with open("CyberText/cyberJson/kasperskyText.json", "r", encoding="utf-8") as file:
        past_data = json.load(file)

    data = past_data

    source_list = getSourceList(past_data)
    with open("CyberText/cyberJson/kasperskyText.jsonl","w",encoding="utf-8") as file:
    ...
    with open("CyberText/cyberJson/kasperskyText.json","w",encoding="utf-8") as file:
