...
def Main():
    ...
    past_data = {}
    with open("CyberText/cyberJson/mcAfeeText.json", "r", encoding="utf-8") as file:
    ...
    with open("CyberText/cyberJson/mcAfeeText.jsonl","w",encoding="utf-8") as file:
    ...
    with open("CyberText/cyberJson/mcAfeeText.json","w",encoding="utf-8") as file:
